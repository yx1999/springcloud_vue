  ...
  <div style="margin-left: 30px;">
    ...
    <el-form :inline="true" class="search">
        ...
        <el-form-item label="银行卡号">
          <el-input v-model="queryForm.accountNumber" style="width: 160px" clearable size="mini" placeholder="请输入...."></el-input>
        </el-form-item>

        <el-form-item label="手续费">
          <el-input v-model="queryForm.commission" style="width: 70px" size="mini" clearable placeholder="请输入...."></el-input>
        </el-form-item>

        <el-form-item label="申请时间">
          <el-date-picker v-model="queryForm.preApplytime" style="width: 130px;" clearable size="mini" type="date"
                          placeholder="开始日期">
          </el-date-picker>
          --
          <el-date-picker v-model="queryForm.nextApplytime" style="width: 130px;" clearable size="mini" type="date"
                          placeholder="结束日期">
          </el-date-picker>
          <el-form-item label="金额">
            <el-input v-model="queryForm.amount" style="width: 80px" size="mini" clearable placeholder="请输入...."></el-input>
          </el-form-item>
        </el-form-item>
    ...
    <el-table :data="result" border style="width: 100%" max-height="430px">
      ...
      <el-table-column prop="amount" label="金额" min-width="15" align="center">
      </el-table-column>
      <el-table-column prop="commission" label="手续费" min-width="10" align="center">
      </el-table-column>
      <el-table-column prop="accountNumber" label="银行卡号" min-width="20" align="center">
      </el-table-column>
      <el-table-column prop="applytime" type="datetime" :formatter="timestampToTime" label="提现时间" min-width="20" align="center">
      </el-table-column>
    ...
    <!-- 添加和编辑 -->
    <el-dialog title="提现纪录审核" :visible.sync="dialogVisible" @close="handleDialogClose" width="70%">
      <el-form :model="Form" :rules="FormRules" ref="Form" style="margin-top: -30px;margin-left: 50px"
        ...
        <el-form-item label="手续费" size="small">
          <el-input v-model="commission" size="small" disabled style="width: 750px"></el-input>
        </el-form-item>

        <el-form-item label="银行卡号" size="small">
          <el-input v-model="accountNumber" size="small" disabled style="width: 750px;"></el-input>
        </el-form-item>

        <el-form-item label="提现时间" size="small">
          <div>{{applytime|formatDate}}</div>
        </el-form-item>
...
<script>
  export default {
    ...
    methods: {
      ...
      ChaXun: function () {
        let url = this.axios.urls.YAO_WITHDRAW_LIST;
      ...
      doSubmitForm: function (value) {
        this.$refs['Form'].validate((valid) => {
          ...
          let url = this.axios.urls.YAO_WITHDRAW_EDIT;
          if (value == 0) {
            this.axios.post(url, {
              id: this.id,
              state: "通过",
