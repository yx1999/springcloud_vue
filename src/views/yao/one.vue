<template>
  <div style="margin-left: 30px;">
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>满标一审管理</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-table :data="result" border style="width: 100%" max-height="430px">
      ...
      <el-table-column prop="state" label="状态" min-width="20" align="center">
      ...
      <el-table-column prop="auditorNameOne" label="审核人" min-width="15" align="center">
      </el-table-column>
    ...
    <!-- 添加和编辑 -->
    <el-dialog title="满标一审审核" :visible.sync="dialogVisible" @close="handleDialogClose" width="80%">
      <el-form :model="Form" :rules="FormRules" ref="Form" style="margin-top: -10px;"
        ...
        <el-row style="margin-top: -30px">
          <el-col :span="6">
            <div class="grid-content bg-purple">
              <el-form-item label="借款描述" size="small" prop="remark">
        ...
        this.$refs['Form'].validate((valid) => {
          ...
          if (value == 0) {
            this.axios.post(url, {
              id: this.id,
              state: "一级通过",
              auditoridone: this.$store.getters.userId,
              remarkone: this.Form.remark
            }).then((resp) => {
              this.$message({
