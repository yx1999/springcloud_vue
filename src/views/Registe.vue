<template>
	<div class="login-wrap">
		<el-form label-position="left" lable-width="0px" class="login-container">
			<h3 class="title">用户注册</h3>
			<el-form-item>
				<el-input v-model="username" placeholder="用户名" autocomplete="off"></el-input>
			</el-form-item>
			<el-form-item>
				<el-input placeholder="请输入密码" v-model="password" show-password autocomplete="off"></el-input>
			</el-form-item>
			<!-- <el-form-item>
				<el-input placeholder="确认密码" v-model="repwd" show-password autocomplete="off"></el-input>
			</el-form-item> -->
			<el-form-item>
				<el-button type="primary" plain style="width: 100%;" @click="doSubmit">注册</el-button>
			</el-form-item>
	...
	export default {
		...
		methods: {
			doSubmit: function() {
				...
				let url = this.axios.urls.SYS_USER_ADD;
